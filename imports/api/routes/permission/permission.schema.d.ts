...
export declare const PermissionCreateInputSchema: import("@sinclair/typebox").TObject<{}>;
export type PermissionCreateInput = Static<typeof PermissionCreateInputSchema>;
export declare const PermissionUpdateInputSchema: import("@sinclair/typebox").TObject<{}>;
export type PermissionUpdateInput = Static<typeof PermissionUpdateInputSchema>;
